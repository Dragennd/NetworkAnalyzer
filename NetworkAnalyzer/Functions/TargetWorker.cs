...
using static NetworkAnalyzer.Functions.LatencyHandler;
using static NetworkAnalyzer.Functions.PacketLossHandler;
using static NetworkAnalyzer.Functions.TimeStampHandler;
