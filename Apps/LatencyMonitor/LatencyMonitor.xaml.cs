...
namespace NetworkAnalyzer.Apps.LatencyMonitor
{
    public partial class LatencyMonitor : UserControl
    {
        ...
        {
            LatencyMonitorDataStorage.ClearDataStorage();
            ...
            do
            {
                LatencyMonitorDataStorage.PacketsSent++;
        ...
        public void UpdateUserInterface(string ipAddress)
        {
            ...
            TxtPacketsSent.Text = LatencyMonitorDataStorage.PacketsSent.ToString();
            ...
            {
                TxtIPInfo1S.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[0].ToString();
                TxtIPInfo1D.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[0].ToString();
            ...
            {
                TxtIPInfo2S.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[1].ToString();
                TxtIPInfo2D.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[1].ToString();
            ...
            {
                TxtIPInfo3S.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[2].ToString();
                TxtIPInfo3D.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[2].ToString();
            ...
            {
                TxtIPInfo4S.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[3].ToString();
                TxtIPInfo4D.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[3].ToString();
            ...
            {
                TxtIPInfo5S.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[4].ToString();
                TxtIPInfo5D.ToolTip = "Resolved IPv4 Address: " + LatencyMonitorDataStorage.ResolvedName[4].ToString();
        ...
        public bool CheckUserInput()
        {
            ...
            else
            {
                foreach (string input in userInput)
                {
                    ...
                    {
                        DataValidation.ResolveDNSNameForTooltip(input);
                        LatencyMonitorDataStorage.IPAddresses.Add(input);
                    }
                }
                return true;
            }
